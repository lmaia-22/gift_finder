...
@Component({
  selector: 'app-quickerproducts',
  templateUrl: './quickerproducts.component.html',
  styleUrls: ['./quickerproducts.component.css']
})
export class QuickerproductsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.orderservice.leastproductiontimeproducts().subscribe(rank => {
      this.ranks = rank['least_duration'];
